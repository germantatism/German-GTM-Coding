...
> **ACTUALIZACIÓN 15-sep-2026 (segunda call):** el ramp del correo de Appmaking es **~20K tx en el mes 1 → ~150K en el mes 7**, no 10K → 150K en el mes 9 como se asumió abajo. Su volumen total es **~500K tx/mes** (agosto 2026), así que 150K es ~30% del total. Antes de rehacer las tablas de la sección 2, cerrar las preguntas de `appmaking-discovery-questions-2026-09-15.md` (curva mes a mes, MIDs, share objetivo). Los escalones del fixed fee no cambian.
