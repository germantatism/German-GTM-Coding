...
Sum of modeled TAM (CO+PE+BO): **~$332M/year**, drivers **~162,000+**. Venezuela intentionally excluded from both sums, not zeroed — see its slide. These are the totals the rest of the Yango deck (executive summary, "The Opportunity," and the levers slide) needs to be reconciled to — see `claude-design-prompt-deck-reconciliation-2026-08-18.md`.
